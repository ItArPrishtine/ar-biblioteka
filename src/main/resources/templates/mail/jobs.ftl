    ...
    <tr>
        <td style="padding: 0 60px">
            ...
            <table>
                <thead>
                <tr>
                    <th style="border: 1px solid #dddddd;text-align: left;padding: 8px; background-color: #eee">Titulli</th>
                    <th style="border: 1px solid #dddddd;text-align: left;padding: 8px; background-color: #eee">Pozita e Punes</th>
                </tr>
                </thead>
                <tbody>
                <#list jobs as job>
                    <tr>
                        <td style="border: 1px solid #dddddd;text-align: left;padding: 8px;">${job.title}</td>
                        <td style="border: 1px solid #dddddd;text-align: left;padding: 8px;">${job.link}</td>
                    </tr>
                </#list>
                </tbody>
            </table>
