                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                            ...
                            <p>Pershendetje ${username},<br>
<br>
Ju sapo keni huazuar librin me&nbsp;titullin "<span style="color:#A52A2A">${bookTitle}</span>" nga <span style="color:#800000">${authorName}</span><br>
<br>
Kategoria: <span style="color:#3366cc">${category}</span><br>
Data e Huazimit:&nbsp;<span style="color:#3366cc">${borrowDate}</span><br>
Data e Kthimit:&nbsp;<span style="color:#3366cc">${dateToReturn}</span></p>
